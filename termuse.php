...
<?php include "./navbar.html"; ?>
	...
	<form>
		<table>
			<tr>
				<td>
					<img src="images/tu.jpg" width="500" height="500">
				</td>
				<td>
					<h2>Just be friendly</h2>
...
<h4>Choose Your (Curse) Words Wisely</h4>
